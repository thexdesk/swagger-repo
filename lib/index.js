...
exports.readConfig = function() {
  let config = {};
  try {
    config = YAML.readYaml(REDOCLY_CONFIG);
  } catch (e) {
    console.warn(`Redocly config not found at ${chalk.yellow(REDOCLY_CONFIG)}. Using empty...`);
  }
  return config;
};
...
exports.compileIndexPage = function(options = {}) {
  ...
  const redocURL = redocConfig.redocURL || 'https://cdn.jsdelivr.net/npm/redoc/bundles/redoc.standalone.js';
