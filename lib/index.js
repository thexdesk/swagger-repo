...
exports.compileIndexPage = function(options = {}) {
  ...
  return fileContents
    ...
    .replace('{{redocBody}}', `<div id="redoc_container"></div>
...
exports.indexMiddleware = function(req, res) {
  res.end(
    exports.compileIndexPage({ livereload: true })
  );
}
...
exports.swaggerUiMiddleware = function () {
  return express.static(Path.dirname(require.resolve('swagger-ui-dist')))
}
...
function runPlugins (swagger) {
  var relativePluginsDir = process.env.SWAGERREPO_PLUGINS_DIR || 'spec/plugins'
