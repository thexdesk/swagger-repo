...
exports.bundle = function(options = {}) {
  const { pathsDir, definitionsDir, componentsDir, mainFile, codeSamplesDir, pluginsDir } = calcPaths(
    options.basedir
  );
...
function runPlugins(spec, options, pluginsDir) {
  const relativePluginsDir =
    process.env.SWAGERREPO_PLUGINS_DIR || pluginsDir;
